...
const (
	...
	DefaultMinRelayTxFee = hcashutil.Amount(1e5)
...
// pool and relayed.
func calcMinRequiredTxRelayFee(serializedSize int64, minRelayTxFee hcashutil.Amount) int64 {
	...
	if minFee < 0 || minFee > hcashutil.MaxAmount {
		minFee = hcashutil.MaxAmount
	}
...
func checkInputsStandard(tx *hcashutil.Tx, txType stake.TxType, utxoView *blockchain.UtxoViewpoint) error {
...
func isDust(txOut *wire.TxOut, minRelayTxFee hcashutil.Amount) bool {
